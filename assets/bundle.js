...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainGame = __webpack_require__(1);
	
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(MainGame, null), document.getElementById('root'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var BlockIndex = __webpack_require__(33);
	var BlockItem = __webpack_require__(34);
	var Timer = __webpack_require__(35);
	var ScoreBoard = __webpack_require__(36);
	var SoundBar = __webpack_require__(171);
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(Timer, { status: this.state.status }),
	        React.createElement('div', { className: 'block-item sidebar-item push' }),
	        React.createElement(SoundBar, null),
	        React.createElement('div', { className: 'sidebar-item image drop-arrow push' }),
	        React.createElement('div', { className: 'sidebar-item image counter push' })
	      ),
	      React.createElement(
	        'div',
	        { id: 'game', className: 'game-block', onClick: this.togglePlay },
	        React.createElement('div', { className: "game-status " + klass, id: 'game-button' }),
	        React.createElement('context', { id: 'ctx' })
	      ),
	      React.createElement(
	        'aside',
	        { className: 'control-board' },
	        React.createElement(ScoreBoard, null),
	        React.createElement(BlockIndex, null),
	        React.createElement('div', { className: 'sidebar-item image clockwise push' })
	      )
	    );
	  }
	...
	var BlockIndex = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'div',
	      null,
	      React.createElement(BlockItem, null),
	      React.createElement(BlockItem, null),
	      React.createElement(BlockItem, null)
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BlockItem = React.createClass({
	  ...
	  render: function () {
	    return React.createElement("div", { className: "block-item sidebar-item" });
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(2);
	var ScoreStore = __webpack_require__(172);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SoundBar = React.createClass({
	  ...
	  render: function () {
	    return React.createElement("div", { className: 'sidebar-item image push ' + this.getIcon(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScoreConstants = __webpack_require__(194);
